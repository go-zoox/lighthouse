...
require (
	...
	github.com/go-zoox/connect v1.0.0
	github.com/go-zoox/dns v1.1.3
...
require (
	github.com/AdguardTeam/dnsproxy v0.43.1 // indirect
	...
	github.com/go-zoox/oauth2 v1.3.0 // indirect
